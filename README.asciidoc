...
we use bttrack and btlaunchmanycursed for bittorrent distribution. Both is
...
current configuration. btlaunchanycurses is started via @reboot crontab from
the tracker user:

---------------------------------
crontab -l |grep reboot
@reboot  /usr/bin/tmux new-session -s bttrack  "/usr/bin/btlaunchmanycurses
/var/www/ftp-master.grml.org/"
--------------------------------

Both use `/var/www/ftp-master.grml.org/` as sourcedir for torrent seeding and allowed
